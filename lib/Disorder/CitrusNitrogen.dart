    ...
    return Scaffold(
      ...
      children: <Widget>[
        ...
        Padding(
          ...
          child: Text(
            'The older leaves are pale green to yellow and abscise. The life of a leaf can be shortened'
            ' from 1-3 years to 6 months. The leaf veins have a clear colour tending to white.',
