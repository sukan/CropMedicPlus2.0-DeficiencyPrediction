...
Crop Medic Plus 2.0 is aim to predit the nutrient disorder in plants (Guava, Groundnut, Citrus). Here i have converted my model(.h5) file into tfile and import that into the flutter mobile app.
